...
This fork has been updated to detect and classify 5 types of grape varieties based on the [Embrapa - Wine Grape Instance Segmentation Dataset](https://github.com/thsant/wgisd) dataset using ROS. The training loop consisted of 5500 iterations and achieved a max mAP value of 73.36%. The prediction results are below.
